...
function blueBalloon() {
  ...
  var blueBalloon = createSprite(0,Math.round(random(10,300)), 10, 10);
...
function greenBalloon() {
  ...
  var greenBalloon = createSprite(0,Math.round(random(30,360)), 10, 10);
...
function pinkBalloon() {
  ...
  var pinkBalloon = createSprite(0,Math.round(random(40,390)),10, 10);
